...
web$foldername="docs2" # output folder name #在上一層
...
```{r}
web$translate_HTML_fromClipboard()

tags$a(class="waves-effect waves-light btn"," button")
tags$a(class="waves-effect waves-light btn", tags$i(class="material-icons left"," cloud"),"button")
tags$a(class="waves-effect waves-light btn", tags$i(class="material-icons right"," cloud"),"button")
```
